...
echo "Restoring pruned state from db_snapshots/builder_beta_pruned_2026-08-20.sql ..."
sqlite3 template_store.sqlite3 < db_snapshots/builder_beta_pruned_2026-08-20.sql
