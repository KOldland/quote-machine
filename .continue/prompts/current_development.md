...
- [ ] G1 — [Session G] End-to-end smoke test: run server, navigate Materials → Further Requirements → Review, confirm no legacy blocks visible, `line_items_by_category` renders + submits, review shows grouped output.
